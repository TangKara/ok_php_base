...
/**
 * this is a copy of \Phalcon\Script\Color
 *
...
final class ColourTerm
{
    ...
    public static function isSupportedShell()
    {
        ...
        if (array_key_exists("TERM", $_ENV)) {
            if (array_key_exists($_ENV["TERM"], self::$_supportedShells)) {
                $flag = true;
            }
        } else {
            if (array_key_exists("TERM", $_SERVER) && array_key_exists($_SERVER["TERM"], self::$_supportedShells)) {
                $flag = true;
            }
        }
